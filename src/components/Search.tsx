...
const Search = () => {
  ...
  return (
    <>
      <div className='flex flex-col sm:flex-row gap-4 shadow-sm bg-white p-2 rounded-2xl border border-slate-200'>
        <div className='relative grow'>
          ...
          <input
            type='text'
            placeholder='Search Name, ICAO, City or State...'
        ...
        {/*    {AIRPORTS.map((state) => (*/}
        {/*      <option key={state.icao} value={state.icao}>*/}
        {/*        {state.state}*/}
        {/*      </option>*/}
        {/*    ))}*/}
        {/*  </select>*/}
