      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <div className="max-w-2xl mx-auto">
          <h2 className="text-2xl font-bold tracking-tight text-white sm:text-3xl mb-4">
            Join the AeroGuide Community
          </h2>
          <p className="text-lg text-slate-300 mb-8">
            Get weekly updates on airport conditions, new charts, and general aviation news delivered straight to your
            inbox.
          </p>

          {status === 'success' ? (
            <div
              className="bg-green-500/10 border border-green-500/20 rounded-xl p-6 animate-in fade-in zoom-in-95 duration-300">
              <div className="flex flex-col items-center justify-center">
                ...
                <h3 className="text-xl font-semibold text-white">Thanks for subscribing!</h3>
                <p className="text-green-200 mt-2">Check your inbox for a welcome message.</p>
                <button
            ...
            <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-3">
              ...
              <button
                type="submit"
                disabled={status === 'submitting'}
                className="sm:flex-shrink-0 px-8 py-3.5 rounded-xl bg-blue-600 hover:bg-blue-500 text-white font-semibold shadow-lg shadow-blue-900/30 transition-all hover:-translate-y-0.5 active:translate-y-0 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-slate-900 focus:ring-blue-500 disabled:opacity-70 disabled:cursor-not-allowed disabled:transform-none min-w-[140px] flex items-center justify-center"
              >
                {status === 'submitting' ? (
          ...
          <p className="mt-4 text-sm text-slate-500">
            We care about your data. Read our <a href="#" className="text-slate-400 hover:text-white underline">Privacy
            Policy</a>.
          </p>
        </div>
      </div>
